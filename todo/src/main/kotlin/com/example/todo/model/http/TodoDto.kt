...
data class TodoDto (
    ...
    @field:ApiModelProperty(value = "일정 설명", example = "13시 스타벅스", required = false)
    var description:String?=null,

    @field:ApiModelProperty(value = "시간", example = "2022-08-15 13:00:00", required = true)
    @field:NotBlank
    //yyyy-MM-dd HH:mm:ss //이전에 학습했던 custom annotation으로 변경 추천
    var schedule: String?=null,

    @field:ApiModelProperty(value = "생성일자", required = false)
    var createAt: LocalDateTime?=null,

    @field:ApiModelProperty(value = "수정일자", required = false)
